<div class="newsletter">
    <div class="content">
        <span>Big news at Young Pizza!</span>
        <h1>Stay in the Pizza Loop!</h1>
        <p>Pizza continues to evolve, blending tradition with bold new trends—think Detroit-style square pies, <br> vegan cheese innovations, and globally inspired toppings like tandoori chicken or truffle-infused sauces.</p>
...
<footer>
    <div class="content">
        <div class="box">
            <img src="image/logo.png" width="280">
            <p>we're always in search for talented and motivated people. Don't be shy introduce your self!</p>
        ...
        <div class="box">
            ...
            <a href=""> <i class="bx bx-chevron-right"></i>News letter</a>
        </div>

        <div class="box">
            <h3>information</h3>
            <a href=""> <i class="bx bx-chevron-right"></i>about</a>
        ...
        <div class="box">
            <h3>extras</h3>
            <a href=""> <i class="bx bx-chevron-right"></i>brans</a>
        ...
        <div class="box">
            <h3>contact us</h3>
            <p><i class="bx bxs-phone"></i>09057831608</p>
            <p><i class="bx bxs-envelope"></i>youngzues48@gmail.com</p>
            <p><i class="bx bxs-location-plus"></i>philippines</p>
            <div class="icons">
    ...
    <div class="bottom">
        <p>John Marcle T. Yangyang Fullstack div</p>
        <a href="admin panel/login">become a seller</a>
    </div>
</footer>