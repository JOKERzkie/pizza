...
<body>
    ...
    <div class="banner">
        <div class="detail">
            <h1>cart</h1> <br>
            <p>  Your cart contains all the delicious items you've selected and is just a step away from checkout! <br>Review your order carefully to make sure everything looks perfect.</p>
